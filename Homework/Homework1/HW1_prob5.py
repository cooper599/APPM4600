...
plt.semilogx(delta_arr,diff_pi,label="x=pi")
plt.semilogx(delta_arr,diff_106,label="x=10^6")
plt.xlabel("deltas")
...
plt.semilogx(delta_arr,diff_myalg_pi,label="x=pi")
plt.semilogx(delta_arr,diff_myalg_106,label="x=10^6")
plt.xlabel("deltas")
plt.ylabel("Difference between equation and manipulated expression")
